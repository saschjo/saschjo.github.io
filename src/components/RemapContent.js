  ...
  return (
    <div className="InnerCaseWrapper">
      ...
      <div className="case-text">
        ...
        <p>In urban development, the voices of teens are often set aside. Many young people in society feel like they don't have any say in the way their city looks and feel, and that even if they did speak up, it wouldn't matter. In this project, we were challenged to create pitch material in the form of a graphic identity and pitch film, as well as further develop a product concept already created and supported by user research done by our classmates to solve this issue. We chose to work on Re:Map. </p>
        ...
        <h3>Our mission</h3>
        <p>Re:Map lacked a distinct graphic identity and voice, hadn't developed a hi-fi concept for what the physical screens and UI would look and feel like, or how to engage with the target user group to promote usage of the product. To connect with teens and get them involved, these things needed to be adressed, and were the main problems we decided to tackle.</p>
      </div>

      <FullImage 
      image={remap_1}
      caption="The concept I'd created for Re:Map prior to the group project."
      />

      <div className="case-text">
        <h3>A modern punk workshop</h3>
        <h4>My moodboard</h4>
        <p>In the days prior to the group project, we were each given one day to complete a moodboard for a concept of our choice. I chose Re:Map. I wanted to encourage physically creating with your hands, which turned into the concept of youth workshops where you could play around with and explore different materials to create and visualize ideas for the future of the city. To attract teens to the concept and make it stand out, I worked hard to incorporate Norman’s three levels of design into the visual language, to meet the emotional needs of participants. This was expressed by bold typography, colors and shapes inspired by industrialism, brutalist genres and Kulturhuset's Lava.</p>
      </div>

      <FullImage 
      image={remap_15}
      caption="The moodboard I, Desirée Strand and Sebastian Åhman created for Re:Map, iterating on my original concept."
      />

      <div className="case-text">
        <h4>Group moodboard</h4>
        <p>For the group project, we had to choose one project to develop pitch material for. We decided to work on Re:Map, and further develop the concept I'd created in my moodboard. We were very inspired by deconstructivism and classic punk and their historical roots. The youth workshop concept was further developed into a modern punk workshop, where you could spend time with other likeminded teens after school and create in a limitless, creative and rebellious space.</p>
        <h3>Design methodology</h3>
        <h4>Design thinking</h4>
        <p>We started out with the design thinking process to build empathy with our user group. This was based on the user research conducted by the original product design group. We explored different ideas and concepts, as well as exploring user insights based on the user data through post-it clusters in Mural.</p>
        <h4>Co-creating remotely</h4>
        <p>Due to the pandemic, this project was done completely remotely. Therefore, we had to communicate well, deliver what we promised and work efficiently through collaborative tools such as Mural, Zoom and Google Drive. An important aspect of our project is that we all worked together on every deliverable: We were each given responsibility for designing and producing individual pieces, but we all came together as a group to iterate, propose new directions and hand off designs to finish different bits and pieces.</p>
      </div>


      <FullImage 
      image={remap_personas}
      caption="Erin and Lo, personas representing our primary target audiance."
      />

      <div className="case-text">
      <h4>Personas</h4>
      <p>To connect with our target audience and their needs, we created two young personas to represent our primary target audience, and two older personas to represent our secondary. These were based on the user research provided to us by the original concept group. The primary audience were teens of varying genders, backgrounds, technical prowess and goals, who felt it was hard to make a difference and that no one would listen if they tried; quotes taken directly from the user research. </p>
      </div>

      <FullImage 
      image={remap_personas2}
      caption="Mikael and Adriana, personas representing our secondary target audience."
      />

      <div className="case-text">
        <p>The secondary audience were adults who were in daily contact with teens, such as parents and high school teachers. What defined them as a group was wanting to help teens make a difference and be a part of their lives, but not knowing how to go about it.</p>
      </div>

      <FullImage 
      image={remap_slogan}
      caption="The Re:Map tagline."
      />

      <div className="case-text">
        <h4>Tagline</h4>
        <p>The tagline was designed collaboratively in the group, and features the words Reset, Redo, and Create. This was meant to be a metaphor for the conceptual timeline Re:Map was offering – first, reset the playing field and allow teens to make their voices heard by taking action. Second, redo through collaboration, changing the city according to their wants, wishes and point of view. Finally, create and let creativity and ideas flow limitlessly to change the world together – that was Re:Map's ethos.</p>
      </div>
      ...
      <FullImage
      image={remap_logo}
      caption="The final logo I created with the tagline added in." />

      <div className="case-text">
        <h3>Logotype and icon</h3>
        <h4>Logotype</h4>
        <p>For the logo, we decided to rework the one from my original concept to fit our new direction more, which I was given responsibility for. I wanted the logo stand out and communicate the visual concept clearly in different situations. For this reason I explored using textures, bright colors we'd worked on and different font weights. The different font weights clarifies the humanist characteristics in Syne, adding to a warm and welcoming look. The two coloured lines represent our primary color scheme as well as the interactive screens, and how ideas put into one end affects the other. The dotted texture can be found throughout the Re:Map visual concept, and adds visual interest. The finalised version also features the addition of our tagline: "Re:set, re:do, create".</p>
      </div>

      <FullImage
      image={remap_icon}
      caption="The final versions of the Re:Map icon." />

      <div className="case-text">
        <h4>Icon</h4>
        <p>Re:Map’s icon is a map pin, signifying the functionality of the product as well as acting as a skeumorphistic UI metaphor on the interactive screens and website. The icon was worked on by me and Sebastian. The pin is also featured throughout the visual language, such as on posters and in the pitch film.</p>
      </div>

      <FullImage 
      image={remap_monster}
      caption="The final color scheme and patterns."
      />

      <div className="case-text">
        <h4>Industrial textures, colourful shapes</h4>
        <p>The look and feel of Re:Map was very important for us. We wanted to include representations of industrial urban textures like metal plating, plywood panels and overgrowth into the design, while keeping a bold, symbolic and colorful aesthetic. To achieve this, we created a bright color palette, and symbolic patterns and shapes that would repeat throughout the profile. Our team mate Desirée Strand created the hashed texture seen throughout the visual language, and I created the dotted one. The color scheme was designed by me, Sebastian and Desirée.</p>
      </div>
      ...
      <div className="case-text">
        <h3>Interactive screen design</h3>
        <h4>Physical design</h4>
        <p>We wanted the interactive screens to call attention to themselves and make a statement in the environment they were placed in: The goal was for teens to get excited and want to interact with them. We played around with different materials, shapes and textures to manifest this in a physical way. We decided on two formats: One futuristic cylindrical screen to allow several users to use the screen at once, and one conventional flat, rectangular screen for single use. </p>
      ...
      <FullImage 
      image={remap_3}
      caption="A mockup of the flat screen (3D by Sebastian Åhman) and the interactive web experience. UI design and website mockup by me."
      />
      ...
      <div className="case-text">
        ...
        <h4>Film concept</h4>
        <p>The deconstructivist, cut out images of teens creating a city together paired with the bright color theme, animation and Viagra Boy’s <em>Ain’t Nice</em> were creative choices we hoped would elicit a feeling of wanting to take back the city from the adults, and make their voices heard whether “the suits wanted to listen or not”. The punk spirit really came through in the making of this film, and it really showcases what Re:Map is all about. <a href={'https://vimeo.com/500366747'}>Watch it here.</a></p>
        <h4>Production</h4>
        <p>I was heavily involved in the pitch film, working on- and drawing concepts, storyboards, transitions, and editing. My main responsibility was motion design and stop motion animation. The graphics were made by Desirée Strand in Adobe Illustrator, and then animated by me in After Effects.  I also shot and created the animated paper sequence seen throughout the video, and wrote most of the copy. Together we produced the Re:Do, Re:Set and Create segments in this way. The final cut was edited by me, Simon Karlsson and Sebastian Åhman.</p>
      </div>
